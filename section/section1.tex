...
\end{teo}
\begin{es}
	Sia $K \subset \R \ , \ K =[-2,2]$ e sia $\dot{x}(t)=x(t)$ , con soluzione $x=x_0e^t$ . K è un intervallo chiuso e limitato , quindi compatto  ,  inoltre la funzione x è continua , quindi le ipotesi del teorema sono rispettate . Controlliamo se K è un viability domanin . Sappiamo che se $x \in (2,2)$ allora $T_K(x) = \R$ , analizziamo ora i due punti di frontiera : 
	\begin{itemize}
