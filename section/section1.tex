...
\begin{es}
	...
	Quindi proviamo a prendere un punto $x_0 = (0,\sqrt{5}) $ e vediamo se esso appartiene al cono tangente 
	\begin{align*}
		f(x_0) & = (0 , 5) \\
		g(x_0) &= 0 \\
	...
	\begin{figure}[h]
		...
		\caption{Esempio \ref{es:1.2} }
		\label{fig:circonferenza}
	\end{figure}\\
	Avendo trovato un punto $x_0$ per cui K non è un viability domain , per il teorema di Nagumo K non è locally viable sotto f 
	\end{es}
\begin{teo}{Viability}{}
